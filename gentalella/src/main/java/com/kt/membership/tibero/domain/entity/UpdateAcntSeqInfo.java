...
public class UpdateAcntSeqInfo {

	private String inPgEpayAcnt;
	private String inAcntId;
	private int	inOutputSeq;
	...
	public int getInOutputSeq() {
		return inOutputSeq;
	}
	public void setInOutputSeq(int inOutputSeq) {
		this.inOutputSeq = inOutputSeq;
	}

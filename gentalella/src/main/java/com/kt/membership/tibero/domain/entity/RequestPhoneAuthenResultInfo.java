...
public class RequestPhoneAuthenResultInfo {
	private String inPgEpayAcnt;
	private String inReqId;
	private String inAuthenNo;
	...
	public String getInAuthenNo() {
		return inAuthenNo;
	}
	public void setInAuthenNo(String inAuthenNo) {
		this.inAuthenNo = inAuthenNo;
	}
